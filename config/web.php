    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'POST authorisation' => 'user/login',
                'POST course' => 'courses/create',
                'GET profile' => 'user/view',
                'GET courses' => 'courses/view',
                'GET visited' => 'visited-courses/view',
                'GET courses/search' => 'courses/search',

                'DELETE course' => 'courses/delete',
                'DELETE visited/<id>' => 'visited-courses/delete',

                'PATCH change_user' => 'user/change',
                'PATCH change' => 'courses/change'
